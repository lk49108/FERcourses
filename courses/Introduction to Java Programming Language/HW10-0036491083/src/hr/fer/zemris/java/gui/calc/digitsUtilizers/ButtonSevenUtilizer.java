 ...
 * and is used for adding {@link JButton} representing digit seven
 * to {@link Container} layout.
 * @author Leonardo Kokot
 * @version 1.0
 */
public class ButtonSevenUtilizer extends  DigitsUtilizerAbstract {

	@Override
	public void add(Container cp, Color color) {
		JButton element = new JButton("7");
