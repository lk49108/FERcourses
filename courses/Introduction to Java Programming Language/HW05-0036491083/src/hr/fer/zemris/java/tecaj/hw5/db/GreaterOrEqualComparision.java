 ...
 * It is used for checking if given String is greater or equal than the other String.
 * @author Leonardo Kokot
 * @version 1.0
 */
public class GreaterOrEqualComparision implements IComparisonOperator{
