...
/**
 * This is class that contains stack-like collection. It contains methods that
 * are suitable for stack, like push, pop and peek. This class provides only one
 * (default) constructor.
 * 
...
public class ObjectStack {
	...
	/**
	 * This is the only instance variable of this stack-like collection. It is
	 * actually a reference to the ArrayIndexedCollection object. It's used for
	 * storing objects.
	 */
	 ...
	 * 
	 * @param value
	 *            Object that is pushed onto this stack.
	 * @throws IllegalArgumentException
	 *             if null is provided as value.
	 */
	 ...
	 * 
	 * @return Returns an element(object) that is taken from top of the stack.
	...
	/**
	 * Takes the value of the element that is situated on top of the stack, but
	 * do not erase it.
	 * 
