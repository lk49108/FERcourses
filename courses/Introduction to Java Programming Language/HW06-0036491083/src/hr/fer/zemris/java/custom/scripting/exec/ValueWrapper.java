...
public class ValueWrapper {
	...
	public ValueWrapper(Object value) {
		try{
			value = prepareForExecution(value);
	...
	public void increment(Object incValue){
		try{
			incValue = prepareForExecution(incValue);
		} catch (RuntimeErrorException ex){
			throw ex;
		}
	...
	public void decrement(Object decValue){
		try{
			decValue = prepareForExecution(decValue);
		} catch (RuntimeErrorException ex){
			throw ex;
		}
	...
	public void multiply(Object mulValue){
		try{
			mulValue = prepareForExecution(mulValue);
		} catch (RuntimeErrorException ex){
			throw ex;
		}
	...
	public void divide(Object divValue){
		try{
			divValue = prepareForExecution(divValue);
		} catch (RuntimeErrorException ex){
			throw ex;
		}
		try{
	...
	public int numCompare(Object withValue){
		try{
			withValue = prepareForExecution(withValue);
		} catch (RuntimeErrorException ex){
			throw ex;
		}
	 ...
	 */
	private Object prepareForExecution(Object valueProvided){
		...
		if(valueProvided instanceof String){
			try{
